...
#define RIVALRY_NP_BONUS		(0)	// 150 additional NP on kill
...
struct _EVENT_STATUS
{
	...
	uint16 ElMoradKillCount;
	uint16 KarusKillCount;
	...
	uint32	m_nBorderDefenseWarPrizeWonExp;
	uint32	m_nBorderDefenseWarPrizeLoserLoyalty;
	uint32	m_nBorderDefenseWarPrizeLoserItem;
	uint32	m_nBorderDefenseWarPrizeLoserExp;
	uint32	m_nBorderDefenseWarMAXLEVEL;
	uint32	m_nBorderDefenseWarMINLEVEL;
