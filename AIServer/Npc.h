...
public:
	...
	INLINE bool isNonAttackableObject() { return GetType() == NPC_GATE_LEVER; }
...
public:
	...
	void Load(uint16 sNpcID, CNpcTable * proto, bool bMonster, uint8 nation = 0, uint16 nEventRoom = 0);
